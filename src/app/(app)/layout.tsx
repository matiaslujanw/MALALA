...
const NAV: NavDef[] = [
  ...
  { href: "/caja", label: "Caja diaria", iconKey: "Wallet", group: "Finanzas", visible: (s) => s.puedeVerCaja },
  { href: "/bancos", label: "Cuentas y saldos", iconKey: "Landmark", group: "Finanzas", visible: (s) => s.puedeVerCaja },
