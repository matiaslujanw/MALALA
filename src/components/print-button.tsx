...
export function PrintButton({ label = "Exportar PDF" }: { label?: string }) {
  return (
    <button
      ...
      className="no-print inline-flex items-center gap-2 rounded-md bg-primary px-4 py-2 text-sm font-medium uppercase tracking-wider text-primary-foreground transition-colors hover:bg-sage-700"
    >
